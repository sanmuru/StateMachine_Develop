...
public sealed class RegexConst<T>(RegexProvider<T> provider, T? constValue) : RegexRange<T>(provider, constValue, constValue, canTakeMinimum: true, canTakeMaximum: true)
{
