...
namespace SamLu
{
    ...
    public class CollectionChangingEventArgs<TCollection, TItem> : ValueChangingEventArgs<TCollection> where TCollection : ICollection<TItem>
    {
        ...
        /// <summary>
        /// 初始化 <see cref="CollectionChangingEventArgs{TCollection, TItem}"/> 类的新实例。实例使用指定的旧值和新值。
        /// </summary>
        /// <param name="oldValue">指定的旧值。</param>
        /// <param name="newValue">指定的新值。</param>
        public CollectionChangingEventArgs(TCollection oldValue, TCollection newValue) : base(oldValue, newValue)
        {
            if (oldValue == null)
            {
    ...
    /// </summary>
    /// <typeparam name="TItem">指定的项类型。</typeparam>
    public class CollectionChangingEventArgs<TItem> : CollectionChangingEventArgs<ICollection<TItem>, TItem>
    {
        /// <summary>
        /// 初始化 <see cref="CollectionChangingEventArgs{TItem}"/> 类的新实例。实例使用指定的旧值和新值。
        /// </summary>
        /// <param name="oldValue">指定的旧值。</param>
        /// <param name="newValue">指定的新值。</param>
        ...
        public CollectionChangingEventArgs(ICollection oldValue, ICollection newValue) : this((ICollection<TItem>)oldValue?.Cast<TItem>().ToList(), (ICollection<TItem>)oldValue?.Cast<TItem>().ToList()) { }
        ...
        /// <param name="oldValue">指定的旧值。</param>
        /// <param name="newValue">指定的新值。</param>
        public CollectionChangingEventArgs(ICollection<TItem> oldValue, ICollection<TItem> newValue) : base(oldValue, newValue) { }
    }
}
