...
namespace SamLu.StateMachine
{
    ...
    /// 表示确定的有限自动机的状态。
    /// </summary>
    public class DFAState : FSMState
    {
        /// <summary>
        ...
        /// <summary>
        /// 初始化 <see cref="DFAState"/> 类的新实例，该实例接受一个指定是否为结束状态的值。
        /// </summary>
        ...
        public override bool AttachTransition(ITransition transition)
        {
        ...
        public override bool RemoveTransition(ITransition transition)
        {
            if (transition == null) throw new ArgumentNullException(nameof(transition));
